...
- Pipeline note: native image generation was intermittent today — 4x `generation_failed` (unknown reason) on long detailed prompts ~11:35-11:43 CDT while a short red-panda probe succeeded. Condensing prompts to ~150 words fixed it. Lesson: keep native image prompts tight.
